  ...
  <div style="max-width:600px;margin:0 auto;background:#fff;">
    ...
    <div style="padding:32px 24px;text-align:center;">
      ...
      <div style="margin:32px 0;">
        ...
        <!-- Facture PDF (bouton bleu cohérent) -->
        <a href="${invoicePdfUrl}" target="_blank" style="display:inline-block;background:#2C3E50;color:#fff;text-decoration:none;padding:12px 24px;border-radius:8px;font-weight:600;font-size:14px;margin-bottom:12px;box-shadow:0 2px 6px rgba(44,62,80,0.25);">
    ...
    <div style="background:#fafafa;padding:32px 24px;border-top:1px solid #e0e0e0;">
      ...
      <div style="background:linear-gradient(135deg, #E3F2FD 0%, #BBDEFB 100%);border-radius:10px;padding:16px 20px;margin-bottom:24px;text-align:center;">
        ...
        <a href="${googleReviewUrl}" target="_blank" style="display:inline-flex;align-items:center;gap:6px;background:#1976D2;color:#fff;text-decoration:none;padding:9px 20px;border-radius:7px;font-weight:600;font-size:13px;box-shadow:0 2px 4px rgba(25,118,210,0.2);">
      ...
      <div style="text-align:center;margin-bottom:24px;">
        <a href="${instagramUrl}" target="_blank" style="display:inline-flex;align-items:center;gap:8px;background:linear-gradient(45deg,#f09433 0%,#e6683c 25%,#dc2743 50%,#cc2366 75%,#bc1888 100%);color:#fff;text-decoration:none;padding:10px 20px;border-radius:8px;font-weight:600;font-size:14px;">
